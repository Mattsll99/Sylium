...
contract SYLIX is ERC20, ERC20Burnable, Ownable {
  ...
  /* ====================== CONSTRUCTOR =============================== */
  constructor() ERC20("SyliumShare", "SYLI") {
  }
  ...
  function mint_sylix(address receiver, uint256 amount) public {
    _mint(receiver, amount);
    emit minting(receiver, amount);
  }

  // Function to burn SYLI 
  function burn_sylix(address burnedFrom, uint256 amount) public {
